export const queryKeys = {
    ...
    machineOmpLoginProviders: (machineId: string) => ['machine-omp-login-providers', machineId] as const,
    sessionOmpExtensionUiRequest: (sessionId: string, requestId: string) => ['session-omp-extension-ui-request', sessionId, requestId] as const,
    ...
    machineOmpModelsForCwd: (machineId: string, cwd: string) => ['machine-omp-models', machineId, cwd] as const,
