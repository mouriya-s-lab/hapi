export default {
  ...
  'settings.voice.credentials.hint': '密钥保存在 Hub 上。浏览器不会长期保存提供商密钥。',
  ...
  'settings.voice.credentials.manageHint': '粘贴 API 密钥以在 Hub 上启用其他转录提供商。',
  ...
  'settings.machines.description': '给设备起自己的名字并检查 hapi-agent skill 就绪状态。离线 runner 仍会保留在列表中。',
  ...
  'settings.machines.skills.refresh': '刷新',
  'settings.machines.skills.refreshing': '刷新中…',
  'settings.machines.skills.refreshError': '探测失败。runner 可能离线或版本过旧。',
  'settings.machines.skills.noReport': '尚无 skill 状态。点击刷新以探测该 runner。',
  'settings.machines.skills.status.ready': '就绪',
  'settings.machines.skills.status.missing': '缺失',
  'settings.machines.skills.status.outdated': '过时',
  'settings.machines.skills.status.conflict': '冲突',
  'settings.machines.skills.status.failed': '探测失败',
  'settings.machines.skills.status.offline': '离线',
  ...
  'settings.fork.omp.title': 'Oh My Pi 提供商',
  ...
  'settings.fork.omp.signIn': '登录',
  'settings.fork.omp.waitingForCallback': '请在提供商页面完成 {provider} 登录。',
  'settings.fork.omp.openLoginPage': '打开登录页面',
  'settings.fork.omp.submitInput': '提交',
  'settings.fork.omp.authenticating': '正在完成 {provider} 登录…',
  'settings.fork.omp.authenticated': '已登录 {provider}。',
  'settings.fork.omp.popupBlocked': '登录弹窗被拦截，请使用上方链接打开。',
  'settings.fork.omp.noProviders': '此 Runner 上没有可用的 OMP 提供商。',
  'settings.fork.users.title': '用户管理',
  'settings.fork.users.description': '管理用户、API Token 与机器授权。',
  'settings.fork.account.title': '我的账号',
  'settings.fork.account.description': '管理记忆与 API Token。',
  'settings.fork.account.pageDescription': '管理只属于当前登录账号的设置。',
  'settings.fork.account.memory': 'Agent 记忆',
  'settings.fork.account.tokens': 'API Token',
  'settings.fork.account.tokenName': '名称（如 laptop）',
  'settings.fork.account.copyNow': '请立即复制保存',
  'settings.fork.account.copied': '已保存',
  'settings.fork.account.revoke': '吊销',
  'settings.fork.users.pageDescription': '选择账号进行管理；当前账号设置位于独立页面。',
  'settings.fork.users.create': '新建用户',
  'settings.fork.user.title': '用户详情',
  'settings.fork.user.backToUsers': '返回用户列表',
  'settings.fork.user.account': '账号',
  'settings.fork.user.username': '用户名',
  'settings.fork.user.initialPassword': '初始密码（至少 8 位）',
  'settings.fork.user.newPassword': '新密码（至少 8 位）',
  'settings.fork.user.role': '系统角色',
  'settings.fork.user.roleUser': '普通用户',
  'settings.fork.user.roleAdmin': '管理员',
  'settings.fork.user.status': '账号状态',
  'settings.fork.user.disabled': '已禁用',
  'settings.fork.user.enable': '启用',
  'settings.fork.user.disable': '禁用',
  'settings.fork.user.resetPassword': '重置密码',
  'settings.fork.user.memory': '用户记忆',
  'settings.fork.user.machineAccess': '机器授权',
  'settings.fork.user.noMachines': '暂无可管理的机器。',
  'settings.fork.user.noAccess': '无权限',
  'settings.fork.user.danger': '危险操作',
  'settings.fork.user.delete': '删除账号',
  'settings.fork.user.deleteConfirm': '确定删除 {username}？',
  'settings.fork.user.notFound': '未找到用户',
  'settings.fork.loading': '正在加载…',
  'settings.fork.action.save': '保存',
  'settings.fork.action.create': '创建',
  'settings.fork.action.delete': '删除',
  'settings.fork.error.load': '加载失败',
  'settings.fork.error.action': '操作失败',
  'settings.fork.grants.title': '资源授权',
  'settings.fork.grants.description': '管理共享资源的 viewer 与 operator 访问权限。',
  'settings.fork.grants.resourceType': '资源类型',
  'settings.fork.grants.sessions': '会话',
  'settings.fork.grants.directories': '目录',
  'settings.fork.grants.machines': '机器',
  'settings.fork.grants.session': '会话',
  'settings.fork.grants.directory': '目录',
  'settings.fork.grants.machine': '机器',
  'settings.fork.grants.search': '搜索资源',
  'settings.fork.grants.manageHint': '查看、添加或移除授权',
  'settings.fork.grants.empty': '没有匹配的资源',
  'settings.fork.grants.dialogTitle': '共享 {resource}',
  'settings.fork.grants.user': '用户',
  'settings.fork.grants.role': '角色',
  'settings.fork.grants.selectUser': '选择用户',
  'settings.fork.grants.add': '添加',
  'settings.fork.grants.remove': '移除',
  'settings.fork.grants.directoryScope': '授权应用到该目录内 {count} 个会话；移除会清理这些会话中的对应授权。',
  'settings.fork.grants.notSignedIn': '未登录',
  'settings.fork.grants.loadFailed': '加载授权失败',
  'settings.fork.grants.updateFailed': '更新授权失败',
  'settings.fork.grants.removeFailed': '移除授权失败',
  ...
  'misc.model': '模型',
  'misc.refreshModels': '刷新模型',
  'misc.refreshingModels': '正在刷新…',
  'misc.ompModelsEmpty': '未发现 OMP 模型',
  'misc.provider': '供应商',
