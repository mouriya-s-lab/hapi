export default {
  ...
  'import.entry': '导入历史会话',
  'import.title': '导入历史会话',
  'import.loading': '正在扫描本地会话…',
  'import.loadFailed': '扫描本地会话失败',
  'import.empty': '未找到可导入的 Claude Code / Codex 会话',
  'import.selectAll': '全选',
  'import.deselectAll': '取消全选',
  'import.selectedCount': '已选 {selected} / {total}',
  'import.action': '导入',
  'import.importing': '导入中…',
  'import.failed': '导入失败',
  'import.result': '已导入 {imported},跳过 {skipped},失败 {failed}',
