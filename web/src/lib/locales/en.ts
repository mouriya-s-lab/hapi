export default {
  ...
  'omp.login.title': 'OMP provider sign-in',
  'omp.login.description': 'Optional OAuth providers are available. Login credentials stay in OMP and are not added to chat.',
  'omp.login.provider': 'Choose a provider',
  'omp.login.action': 'Sign in to {provider}',
  'omp.login.submit': 'Sign in',
  'omp.login.pending': 'Complete the provider flow from the login card in chat.',
  'omp.login.authenticated': 'Signed in: {providers}',
  'omp.login.error': 'OMP sign-in failed: {message}',
  ...
  'settings.fork.summary': 'Session import',
