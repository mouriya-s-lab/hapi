export default {
  ...
  'login.method.token': 'API token',
  'login.username.placeholder': 'Username',
  'login.password.placeholder': 'Password',
  'login.error.enterCredentials': 'Enter username and password',
  ...
  'settings.voice.credentials.hint': 'Keys stay on the hub. The browser never keeps long-lived provider secrets.',
  ...
  'settings.voice.credentials.manageHint': 'Paste an API key to enable another transcription provider on the hub.',
  ...
  'settings.machines.description': 'Name your machines and inspect hapi-agent skill readiness. Offline runners remain listed.',
  ...
  'settings.machines.skills.label': 'hapi-agent skill',
  'settings.machines.skills.refresh': 'Refresh',
  'settings.machines.skills.refreshing': 'Refreshing…',
  'settings.machines.skills.refreshError': 'Could not probe this runner. It may be offline or running an older HAPI version.',
  'settings.machines.skills.noReport': 'No skill report yet. Refresh to probe this runner.',
  'settings.machines.skills.status.ready': 'ready',
  'settings.machines.skills.status.missing': 'missing',
  'settings.machines.skills.status.outdated': 'outdated',
  'settings.machines.skills.status.conflict': 'conflict',
  'settings.machines.skills.status.failed': 'probe failed',
  'settings.machines.skills.status.offline': 'offline',
  ...
  'settings.fork.omp.title': 'Oh My Pi providers',
  ...
  'settings.fork.omp.signIn': 'Sign in',
  'settings.fork.omp.waitingForCallback': 'Complete sign-in for {provider} in the provider page.',
  'settings.fork.omp.openLoginPage': 'Open sign-in page',
  'settings.fork.omp.submitInput': 'Submit',
  'settings.fork.omp.authenticating': 'Finishing sign-in for {provider}…',
  'settings.fork.omp.authenticated': 'Signed in to {provider}.',
  'settings.fork.omp.popupBlocked': 'The sign-in popup was blocked. Use the link shown above.',
  'settings.fork.omp.noProviders': 'No OMP providers are available on this runner.',
  'settings.fork.users.title': 'User management',
  'settings.fork.users.description': 'Manage users, API tokens, and machine access.',
  'settings.fork.account.title': 'My account',
  'settings.fork.account.description': 'Manage memory and API tokens.',
  'settings.fork.account.pageDescription': 'Settings that belong only to the signed-in account.',
  'settings.fork.account.memory': 'Agent memory',
  'settings.fork.account.tokens': 'API tokens',
  'settings.fork.account.tokenName': 'Name (for example, laptop)',
  'settings.fork.account.copyNow': 'Copy and save this token now',
  'settings.fork.account.copied': 'Saved',
  'settings.fork.account.revoke': 'Revoke',
  'settings.fork.users.pageDescription': 'Select an account to manage it. Your own account settings are separate.',
  'settings.fork.users.create': 'Create user',
  'settings.fork.user.title': 'User details',
  'settings.fork.user.backToUsers': 'Back to users',
  'settings.fork.user.account': 'Account',
  'settings.fork.user.username': 'Username',
  'settings.fork.user.initialPassword': 'Initial password (at least 8 characters)',
  'settings.fork.user.newPassword': 'New password (at least 8 characters)',
  'settings.fork.user.role': 'System role',
  'settings.fork.user.roleUser': 'User',
  'settings.fork.user.roleAdmin': 'Administrator',
  'settings.fork.user.status': 'Account status',
  'settings.fork.user.disabled': 'Disabled',
  'settings.fork.user.enable': 'Enable',
  'settings.fork.user.disable': 'Disable',
  'settings.fork.user.resetPassword': 'Reset password',
  'settings.fork.user.memory': 'User memory',
  'settings.fork.user.machineAccess': 'Machine access',
  'settings.fork.user.noMachines': 'No machines are available.',
  'settings.fork.user.noAccess': 'No access',
  'settings.fork.user.danger': 'Danger zone',
  'settings.fork.user.delete': 'Delete account',
  'settings.fork.user.deleteConfirm': 'Delete {username}?',
  'settings.fork.user.notFound': 'User not found',
  'settings.fork.loading': 'Loading…',
  'settings.fork.action.save': 'Save',
  'settings.fork.action.create': 'Create',
  'settings.fork.action.delete': 'Delete',
  'settings.fork.error.load': 'Failed to load',
  'settings.fork.error.action': 'Action failed',
  'settings.fork.grants.title': 'Resource grants',
  'settings.fork.grants.description': 'Manage viewer and operator access to shared resources.',
  'settings.fork.grants.resourceType': 'Resource type',
  'settings.fork.grants.sessions': 'Sessions',
  'settings.fork.grants.directories': 'Directories',
  'settings.fork.grants.machines': 'Machines',
  'settings.fork.grants.session': 'Sessions',
  'settings.fork.grants.directory': 'Directories',
  'settings.fork.grants.machine': 'Machines',
  'settings.fork.grants.search': 'Search resources',
  'settings.fork.grants.manageHint': 'View, add, or remove grants',
  'settings.fork.grants.empty': 'No matching resources',
  'settings.fork.grants.dialogTitle': 'Share {resource}',
  'settings.fork.grants.user': 'User',
  'settings.fork.grants.role': 'Role',
  'settings.fork.grants.selectUser': 'Select user',
  'settings.fork.grants.add': 'Add',
  'settings.fork.grants.remove': 'Remove',
  'settings.fork.grants.directoryScope': 'Applies to {count} sessions in this directory. Removing a grant clears it from those sessions.',
  'settings.fork.grants.notSignedIn': 'Not signed in',
  'settings.fork.grants.loadFailed': 'Failed to load grants',
  'settings.fork.grants.updateFailed': 'Failed to update grant',
  'settings.fork.grants.removeFailed': 'Failed to remove grant',
  ...
  'misc.model': 'Model',
  'misc.refreshModels': 'Refresh models',
  'misc.refreshingModels': 'Refreshing…',
  'misc.ompModelsEmpty': 'No OMP models discovered',
