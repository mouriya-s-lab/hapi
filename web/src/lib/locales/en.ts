export default {
  ...
  'usage.subtitle': 'Input/output/cache token usage aggregated by model',
  'usage.nav': 'Token usage',
  'usage.back': 'Back',
  ...
  'usage.host.label': 'Filter by machine',
  'usage.host.all': 'All machines',
  'usage.refreshing': 'Refreshing…',
  'usage.loading': 'Loading…',
  'usage.error.title': 'Failed to load',
  'usage.error.fallback': 'Could not fetch usage data',
  'usage.empty.title': 'No data',
  'usage.empty.hintAll': 'No session has produced messages with usage info yet.',
  'usage.empty.hintFiltered': 'No usage records match the current filters. Try widening the time range or switching machines.',
  'usage.overview': 'Overview',
  'usage.overviewSummary': '{requests} requests · {tokens} tokens',
  'usage.detail': 'Details',
  'usage.legend.input': 'Input',
  'usage.legend.output': 'Output',
  'usage.legend.cacheCreation': 'Cache creation',
  'usage.legend.cacheRead': 'Cache read',
