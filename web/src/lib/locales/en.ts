export default {
  ...
  'newSession.opencodeModel.loading': 'Discovering agent models…',
  'newSession.opencodeModel.loadFailed': 'Failed to load agent models',
  'newSession.opencodeModel.retry': 'Retry',
  'newSession.opencodeModel.empty': 'No agent models discovered for this directory',
