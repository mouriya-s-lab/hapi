...
export function SyntaxHighlighter(props: SyntaxHighlighterProps) {
    ...
    return (
        <div className="aui-md-codeblock min-w-0 w-full max-w-full overflow-x-auto overflow-y-hidden rounded-b-xl bg-[var(--app-code-bg)]">
            <div className="aui-md-codeblock-grid grid w-max min-w-full text-sm font-mono" style={codeGridStyle}>
                <pre
                    aria-hidden="true"
                    className="aui-md-codeblock-gutter m-0 select-none px-3 py-3 text-left text-[var(--app-hint)]/70"
                >
                    {lineNumbers}
                </pre>
                <pre className="aui-md-codeblock-content shiki m-0 px-4 py-3">
