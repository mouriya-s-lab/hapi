...
/**
 * Tests for V9→V10 schema migration: multi-user support. Adds owner_account_id
 * to machines/sessions and creates accounts / api_tokens / resource_grants.
 * Mirrors migration-v9.test.ts.
 */
describe('Store V9→V10 migration: multi-user', () => {
    ...
    it('V9 DB migrates to V10: new columns null on existing rows, tables created', () => {
