...
export function createPermissionsRoutes(getSyncEngine: () => SyncEngine | null, store: Store): Hono<WebAppEnv> {
    ...
    app.post('/sessions/:id/permissions/:requestId/approve', async (c) => {
        ...
        const sessionResult = requireSessionFromParam(c, engine, { requireActive: true, store, requireOperate: true })
