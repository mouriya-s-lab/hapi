...
import { DISPLAY_IMAGE_PROMPT_CLAUDE, DISPLAY_MEDIA_PROMPT_CLAUDE, DISPLAY_VIDEO_PROMPT_CLAUDE, SEND_FILE_PROMPT_CLAUDE } from "@/modules/common/displayImagePrompt";
