...
export const AGENT_FLAVORS = ['claude', 'codex', 'cursor', 'gemini', 'kimi', 'opencode', 'omp'] as const
...
export const OMP_PERMISSION_MODES = ['default', 'read-only', 'safe-yolo', 'yolo'] as const
